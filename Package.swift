...
let package = Package(
    ...
    dependencies: [
		...
		.package(url: "https://github.com/Kiwijane3/GUtil.git", .branch("master"))
    ],
    targets: [
	.systemLibrary(name: "CGtk", pkgConfig: "gtk+-3.0 gdk-3.0 pangocairo pangoft2 pango gobject-2.0 gio-unix-2.0 glib-2.0",
	    providers: [
        ...
        .target(name: "Gtk", dependencies: ["GtkCHelpers", "Gdk", "Atk", "GUtil"]),
